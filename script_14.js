...
// Кнока "Сбросить"
    ...
    let inputText = document.querySelectorAll("input[type='text']:not([class^='result-t'])");
...
AppData.prototype.completePrgm = function() {
...
periodSelect.addEventListener('click', appData.calcPeriod.bind(appData));
